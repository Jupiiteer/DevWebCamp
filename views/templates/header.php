...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            ...
            <a href=" /workshops-conferencias" class="navegacion__enlace <?php echo pagina_actual('/workhops-conferencias') ? 'navegacion__enlace-actual' : ''; ?>"">Workshops / Conferencias</a>
            <a href=" /registro" class="navegacion__enlace <?php echo pagina_actual('/registros') ? 'navegacion__enlace-actual' : ''; ?>"">Comprar Pase</a>
        </nav>
    </div>
</div>