    ...
    <?php if (!empty($eventos)) { ?>
        <table class="table">
            <thead class="table__thead">
                <tr>
                    <th scope="col" class="tablet__th">Evento</th>
                    <th scope="col" class="tablet__th">Categoría</th>
                    <th scope="col" class="tablet__th">Día y Hora</th>
                    <th scope="col" class="tablet__th">Ponente</th>
                    <th scope="col" class="tablet__th"></th>
                </tr>
            </thead>
